...
export const vueTransformer: Transformer = {
  name: "vue",
  transform: async (inputFile: InputFile, context: TransformerContext) => {
    if (!cachedVueLoader) {
    ...
    return vueTransformer.transform(inputFile, context);
  },
};
